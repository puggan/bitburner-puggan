...
export async function main(ns) {
    ns.exec('scan.ts', 'home', {threads: 1, preventDuplicates: true});
    await ns.sleep(1000);
    ns.exec('watch.js', 'home', {threads: 1, preventDuplicates: true}, 10, 'home', 'scan.ts');
    // ns.exec('watch.js', 'home', {threads: 1, preventDuplicates: true}, 100, 'home', 'buyMaxServers.js');
